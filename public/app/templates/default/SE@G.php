...
<div class="img-overlay">
    ...
    <div class="text-wrapper">
        <h2 style="margin-top: -50px;" class="image-text">Powered by<br /> Social Enterprise @ Goizueta</h2>
    </div>
</div>
...
<div class="row">
    <div class="small-6 medium-6 large-6 columns">
        <img id="SEGImg" src="<?php echo helpers\url::template_path() . 'img/SEG-Logo-09.png' ?>">
    </div>
    <div class="small-6 medium-6 large-6 columns">
