...
<div class="row">
    <div class="small-10 small-offset-1 light-font-smaller" >
        ...
        <p>Transparent Trade Coffee works with direct trade roasters that are genuinely committed to transparency in their
        ...
        <p>Transparent Trade Coffee provides a simple communication vehicle so that
            ...
            Coffees page help consumers make an informed decision. When they are

            satisfied with the economic treatment of the coffee grower, they click on the

            listing to go to the roaster's on-line store to learn more and make their coffee

            purchase.</p>
        <h3 class="sub-header">How to Register?</h3>
        <p><b>Complete the online registration form </b> which requires you to input the coffee

            name, the (on-line) retail price (including currency and bag size), a comment on the

            coffee (optional and limited to 140 characters), the coffee grower's (i.e., farm or

            cooperative) name and location (country), the web page address (where coffee is

            listed for sales) and the green price per pound (f.o.b.) paid to the grower.

            Each registration also requires you to upload

            your logo along with documentation of the green price paid per pound (terms of

            sale).</p>
        <p><b>Confirm the listing after our processing and validation processes are complete.</b> After registered
            ...
            confirm the listing. Once confirmed, your coffees will be posted to the TT
