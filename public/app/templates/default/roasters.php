            ...
            <tbody>
                <?php
                    foreach ($data['roasters'] as $roaster) {
                        echo "<tr>";
                        echo "<td class='custom-table-cell'><b>" . $roaster->roaster_name . "</b></td>";
