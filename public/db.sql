...
# Database: ttc
# Generation Time: 2015-06-20 17:54:25 +0000
# ************************************************************
...
# Dump of table ttc_members
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ttc_members`;

CREATE TABLE `ttc_members` (
...
LOCK TABLES `ttc_members` WRITE;
/*!40000 ALTER TABLE `ttc_members` DISABLE KEYS */;

INSERT INTO `ttc_members` (`memberID`, `username`, `password`, `email`, `addedDate`)
VALUES
	(1,'Demo','$2y$12$UwWuRhQtfROz4/mzbfgY.Oas5tReZrQK187iVEA77LMkW/9HIhMsS','demo@demo.com','2014-12-08 19:07:19');

/*!40000 ALTER TABLE `ttc_members` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ttc_post_cats
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ttc_post_cats`;

CREATE TABLE `ttc_post_cats` (
...
LOCK TABLES `ttc_post_cats` WRITE;
/*!40000 ALTER TABLE `ttc_post_cats` DISABLE KEYS */;

INSERT INTO `ttc_post_cats` (`catID`, `catTitle`, `catSlug`)
VALUES
	(1,'General','general'),
	(2,'Demo','demo');

/*!40000 ALTER TABLE `ttc_post_cats` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ttc_posts
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ttc_posts`;

CREATE TABLE `ttc_posts` (
...
LOCK TABLES `ttc_posts` WRITE;
/*!40000 ALTER TABLE `ttc_posts` DISABLE KEYS */;

INSERT INTO `ttc_posts` (`postID`, `postTitle`, `postSlug`, `postDesc`, `postCont`, `postImg`, `postDate`, `catID`)
VALUES
...
/*!40000 ALTER TABLE `ttc_posts` ENABLE KEYS */;
UNLOCK TABLES;
